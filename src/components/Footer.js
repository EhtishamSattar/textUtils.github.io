      ...
      <div className="row">
        <div className="col-lg-3 col-md-6 mb-4 mb-md-0">
          ...
          <ul className="list-unstyled mb-0" style={{textDecoration:"none"}}>
            <li>
              <a href="#!" className="text-white" style={{textDecoration:"none"}}>Link 1</a>
            </li>
            <li>
              <a href="#!" className="text-white" style={{textDecoration:"none"}}>Link 2</a>
            </li>
            <li>
              <a href="#!" className="text-white">Link 3</a>
            </li>
            <li>
              <a href="#!" className="text-white" style={{textDecoration:"none"}}>Link 4</a>
            </li>
          </ul>
        </div>
        <div className="col-lg-3 col-md-6 mb-4 mb-md-0">
          ...
          <ul className="list-unstyled mb-0">
            ...
            <li>
              <a href="#!" className="text-white" style={{textDecoration:"none"}}>Link 3</a>
            </li>
            <li>
              <a href="#!" className="text-white" style={{textDecoration:"none"}}>Link 4</a>
            </li>
